...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'lstCallList
        '
        Me.lstCallList.BackColor = System.Drawing.Color.Orange
        ...
        Me.ToolTip1.SetToolTip(Me.lstCallList, "Recorded Complaints")
        '
        'ContextMenu2
        '
        ...
        Me.btnAllCalls.Size = New System.Drawing.Size(112, 18)
        Me.btnAllCalls.TabIndex = 85
        Me.btnAllCalls.TabStop = False
        Me.btnAllCalls.Text = "ALL COMPLAINTS"
        ...
        'btnCreateCallSub
        '
        Me.btnCreateCallSub.BackColor = System.Drawing.Color.White
        ...
        Me.btnCreateCallSub.ForeColor = System.Drawing.Color.Firebrick
        ...
        'btnRemoveCallSub
        '
        Me.btnRemoveCallSub.BackColor = System.Drawing.Color.White
        ...
        Me.btnRemoveCallSub.ForeColor = System.Drawing.Color.Firebrick
        ...
        'btnUpdateCallSub
        '
        Me.btnUpdateCallSub.BackColor = System.Drawing.Color.White
        ...
        Me.btnUpdateCallSub.ForeColor = System.Drawing.Color.Firebrick
        ...
        'btnCreateCall
        '
        Me.btnCreateCall.BackColor = System.Drawing.Color.White
        ...
        Me.btnCreateCall.ForeColor = System.Drawing.Color.Firebrick
        ...
        'btnRemoveCall
        '
        Me.btnRemoveCall.BackColor = System.Drawing.Color.White
        ...
        Me.btnRemoveCall.ForeColor = System.Drawing.Color.Firebrick
        ...
        'btnUpdateCall
        '
        Me.btnUpdateCall.BackColor = System.Drawing.Color.White
        ...
        Me.btnUpdateCall.ForeColor = System.Drawing.Color.Firebrick
        ...
        Me.Button8.ForeColor = System.Drawing.Color.Firebrick
        ...
        Me.databaselayout.ForeColor = System.Drawing.Color.Firebrick
        ...
        Me.Label13.Text = "To change the List Box options that appear in Comlab Complaints Logger, simply ed" & _
        "it the text boxes appearing in light blue and select the desired action button t" & _
        "o update the database. Please note that all changes are irreversible."
        '
        'Panel4
        '
        ...
        'txtSQLstatement
        '
        Me.txtSQLstatement.BackColor = System.Drawing.Color.White
        ...
        Me.txtSQLstatement.ForeColor = System.Drawing.Color.Firebrick
        ...
        '
        Me.txtCallSubDescription.BackColor = System.Drawing.Color.White
        ...
        Me.txtCallSubDescription.ForeColor = System.Drawing.Color.Firebrick
        ...
        'txtCallDescription
        '
        Me.txtCallDescription.BackColor = System.Drawing.Color.White
        ...
        Me.txtCallDescription.ForeColor = System.Drawing.Color.Firebrick
        ...
        Me.Text = "Comlab Complaints Logger Management Module 1.0"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            MsgBox("An error occurred in Comlab Complaints Logger Management Module's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
            ...
            If File.Exists((Application.StartupPath & "\").Replace("\\", "\") & "config.ini") = True Then
                ...
                If application_exit = False Then
                    ...
                    Try
                        ...
                        ApplicationName = "Comlab Complaints Logger Management Module"
    ...
    Public Sub WorkerHandler(ByVal Result As String)
        Try
            If Result.StartsWith("Server") = False Then
                ...
                Else
                    If CInt(Result.Split(" ")(0)) > 0 Then
                        StatusBar.Text = Worker1.ActivityLog.Log_ID & " Complaint Successfully Retrieved"
                        StatusBar.ForeColor = Color.LimeGreen
                        'lstLogID.ForeColor = Color.Green
                        'lstLogID.Text = Worker1.ActivityLog.Log_ID
                    ...
                    Else
                    StatusBar.Text = Worker1.ActivityLog.Log_ID & " Complaint Retrieval Failed"
                    StatusBar.ForeColor = Color.Red
                    '  lstLogID.ForeColor = Color.Red
                    End If
                End If
                ...
                Select Case threadselect
                    ...
                    Case 2
                        If Worker1.serverstatus.Text = "SQL Server Status: Online" Then
                            ...
                            '    End If
                            '    MsgBox("You need to ensure that all inputs marked with a red asterisk are filled in before saving an Complaint." & vbCrLf & errorl, MsgBoxStyle.Information, "Save Request Rejected")
                            'Else
                                run_worker(threadselect)
                            'End If
                        Else
    ...
    Private Sub MenuItem5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem5.Click
        Try
            ...
            apptorun = """" & (Application.StartupPath & "\Comlab Complaints Logger Management Module.exe").Replace("\\", "\") & """"
    ...
    Private Sub fill_in_data()
        ...
        If Worker1.serverstatus.Text = "SQL Server Status: Online" Then
            Try
                ...
                conn.Open()
                Try
                    lblStats.Text = "Quick Stats for Comlab Complaint Logger"
    ...
    'Private Sub lstCustomerTypeID_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    Try
    ...
    'Private Sub lstCustomerType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    Try
    '        lstCustomerTypeCover.Text = lstCustomerType.Text
    ...
    Private Sub colourbuttons(ByVal inputbutton As Button)
        Try
            Dim choice() As Button = {btnAllCalls}
            ...
            If result <> -1 Then
                choice(result).BackColor = Color.LightYellow
            End If
        Catch ex As Exception
    ...
    Private Sub btnCreateUser_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        force_check(51)
    End Sub
    ...
    Private Sub btnUpdateUser_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        force_check(53)
    End Sub
